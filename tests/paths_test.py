...
files = [root/'index.html', root/'css/style.css', root/'css/premium-v010.css', root/'css/training-v011.css', root/'js/app.js', root/'js/data/content.js', root/'js/data/training.js', root/'sw.js', root/'manifest.webmanifest']
patterns = [
