window.C190_Save = (() => {
  ...
  const KEY = "central190_save_v44";
  const BACKUP = "central190_save_v44_backup";
  const LEGACY = [
    "central190_save_v43",
  ...
  function migrate(raw) {
    ...
    base.release = { ...base.release, ...(source.release || {}), version: VERSION, phase: 47, visualRecovery: 1, campaignVersion: 2, scenarioDepthVersion: 1,
